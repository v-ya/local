...
typedef struct media_runtime_task_s* (*media_runtime_emit_f)(struct media_runtime_task_s *restrict task, const refer_t pri_data[], struct media_runtime_s *restrict rt, struct media_runtime_unit_context_s *restrict uc);
...
#define d_media_runtime__emit(_name)            struct media_runtime_task_s* media_runtime_symbol(emit, _name)(struct media_runtime_task_s *restrict task, const refer_t pri_data[], struct media_runtime_s *restrict rt, struct media_runtime_unit_context_s *restrict uc)
