...
{
	uintptr_t size;
	cell_size = (cell_size + info->cell_addend + info->cell_align - 1) / info->cell_align * info->cell_align;
	...
	cell->used_size = (size + info->size_align - 1) / info->size_align * info->size_align;
