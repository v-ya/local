...
typedef inst_web_server_tag_s* (*inst_web_server_tag_allocer_f)(pocket_s *restrict pocket, const pocket_attr_t *restrict item);
typedef refer_t (*inst_web_server_tag_pri_allocer_f)(inst_web_server_tag_s *restrict r, pocket_s *restrict pocket, const pocket_attr_t *restrict item);
typedef web_server_request_flag_t (*inst_web_server_flags_modify_f)(web_server_request_flag_t flags);

typedef inst_web_server_value_s* (*inst_web_server_value_allocer_f)(void);
typedef const char* (*inst_web_server_value_f)(inst_web_server_value_s *restrict r, uintptr_t *restrict length);
...
struct inst_web_server_tag_s {
	...
	inst_web_server_tag_pri_allocer_f allocer;
