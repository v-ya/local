...
typedef inst_web_server_tag_s* (*inst_web_server_tag_builder_f)(pocket_s *restrict pocket, const pocket_attr_t *restrict item);
...
typedef const char* (*inst_web_server_value_f)(inst_web_server_value_s *restrict r, uintptr_t *restrict length, const uhttp_s *restrict req, const uhttp_s *restrict res);
