...
static vkaa_var_s* vkaa_std_type_null_create(const vkaa_type_s *restrict type, vkaa_scope_s *restrict scope)
{
...
{
	return vkaa_std_tpool_set(tpool, "null", typeid->id_null, vkaa_std_type_null_create);
}
