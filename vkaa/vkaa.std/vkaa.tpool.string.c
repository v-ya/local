...
static vkaa_var_s* vkaa_std_type_string_create(const vkaa_type_s *restrict type, vkaa_scope_s *restrict scope)
{
...
{
	return vkaa_std_tpool_set(tpool, "string", typeid->id_string, vkaa_std_type_string_create);
}
