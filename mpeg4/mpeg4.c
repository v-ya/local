...
stuff_method_call_d2(set, av1C_seq, uint8_t, seq_profile, uint8_t, seq_level_idx_0)
...
{
	return stuff_method_call(r, set$av1C_flag, seq_tier_0, high_bitdepth, twelve_bit, monochrome, chroma_subsampling_x, chroma_subsampling_y, chroma_sample_position);
}
