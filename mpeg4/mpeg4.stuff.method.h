...
typedef const mpeg4_stuff_t* (*mpeg4_stuff_func$add$dfLa_metadata)(mpeg4_stuff_t *restrict r, uint8_t type, const void *data, uint64_t size);
...
typedef enum mpeg4_stuff_method_t {
	...
	mpeg4_stuff_method$add$dfLa_metadata,
